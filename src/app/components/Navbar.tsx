    ...
    return (
        <nav className={`${className}`}>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a title="Shankar Bhandari" href="https://www.linkedin.com/in/shankar-bhandari-111b2b279/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <span className="self-center text-2xl font-semibold text-white whitespace-nowrap">Shankar Bhandari</span>
                </a>
                <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <a title="Contact Me" href="mailto:bhandarishankar.official@gmail.com" className="text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center  bg-blue-600  hover:bg-blue-700  focus:ring-blue-800">Hire me</a>
