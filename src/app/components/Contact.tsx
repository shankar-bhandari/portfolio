                ...
                <div className="w-full md:w-1/2 px-4">
                  <div className="mb-8">
                    ...
                    <input
                      ...
                      className="w-full border border-transparent bg-[#FFFFFF] rounded-md shadow-one shadow-signUp py-3 px-6 text-body-color text-base placeholder-body-color outline-none focus-visible:shadow-none focus:border-blue-700"
                    />
                ...
                <div className="w-full md:w-1/2 px-4">
                  <div className="mb-8">
                    ...
                    <input
                      ...
                      className="w-full border border-transparent bg-[#FFFFFF] rounded-md shadow-one shadow-signUp py-3 px-6 text-body-color text-base placeholder-body-color outline-none focus-visible:shadow-none focus:border-blue-700 bg-[#FFFFFF]"
                    />
                ...
                <div className="w-full px-4">
                  <div className="mb-8">
                    ...
                    <textarea
                      ...
                      className="w-full border border-transparent bg-[#FFFFFF] rounded-md shadow-one shadow-signUp py-3 px-6 text-body-color text-base placeholder-body-color outline-none focus-visible:shadow-none focus:border-blue-700 resize-none"
                    ></textarea>
