...
export default function Contact() {
    ...
    const sendMessage = () => {
        try {
            ...
            toast.info("UNDER DEVELOPMENT: Please directly mail to bhandarishankar.officail@gmail.com");
        } catch (error) {
            console.log(error);
            ...
            <div className="container mx-auto">
                <div className="max-w-screen-md mx-auto">
                    <div className="bg-opacity-[3%] bg-dark rounded-md p-11 md:mb-12 lg:mb-5 sm:p-[55px] lg:p-11 xl:p-[55px] wow fadeInUp" data-wow-delay=".15s" style={{
                        ...
                        <h2 className="text-white font-bold text-white text-2xl sm:text-3xl lg:text-2xl xl:text-3xl mb-3">Need Help?</h2>

                        <p className="text-white text-base font-medium mb-12">Feel free to reach out to me for any questions or opportunities or mail me directly on <a href="mailto:bhandarishankar.official@gmail.com" className="underline text-blue-700" title="Contact Me">bhandarishankar.official@gmail.com</a></p>
