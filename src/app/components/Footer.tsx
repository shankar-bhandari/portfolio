            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex mb-8 justify-center md:mb-0 space-x-8 rtl:space-x-reverse">
                        <a href="https://facebook.com/shankarbhandari2001" target="_blank" title="Facebook Page" className="text-green-400 hover:text-white">
                       ...
                       {/* <a href="https://twitter.com/so" target="_blank" title="Twitter Page" className="text-green-400 hover:text-white">
                        ...
                        <a href="https://www.linkedin.com/in/shankar-bhandari-111b2b279/" title="Linkedin Page" target="_blank" className="text-green-400 hover:text-white">
                        ...
                        <a href="https://github.com/shankar-bhandari/" title="Github Account" target="_blank" className="text-green-400 hover:text-white">
                ...
                <span className="block text-sm sm:text-center text-gray-400">© 2023 <a href="https://localhost/" className="hover:underline">Shankar Bhandari</a>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}
